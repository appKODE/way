...
include(":sample-compose:main-parallel:routing")
include(":sample-compose:main-parallel:ui")
include(":sample-compose:categories:routing")
include(":sample-compose:categories:ui")
